...
const parseResumeText = (text) => {
  ...
  // Mock prediction based on skills
  const highFitSkills = ["javascript", "react", "node.js", "python", "java"];
  resumeData.prediction = resumeData.skills.some((skill) =>
    highFitSkills.includes(skill.toLowerCase())
  )
    ? "High fit for the role"
          ...
          {isLoading ? (
            ...
            <div className="bg-gray-50 p-8 rounded-xl shadow-lg border border-gray-200 space-y-8">
              ...
              <div className="space-y-8">
                {/* Skills */}
                <div>
                  <h4 className="text-xl font-medium text-gray-700 mb-4">Skills</h4>
                ...
                {/* Fit Prediction */}
                {resumeData.prediction && (
                  <div>
                    <h4 className="text-xl font-medium text-gray-700 mb-4">Fit Prediction</h4>
                    <p className="text-gray-600 text-sm">
                      Predicted fit for the role:{" "}
                      <span
                        className={`font-medium ${
                          resumeData.prediction.includes("High") ? "text-green-600" : "text-yellow-600"
                        }`}
                      >
                        {resumeData.prediction}
                      </span>
