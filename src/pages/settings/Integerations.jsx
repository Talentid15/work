...
const Integerations = () => {
  return (
    <div className="w-[90%] min-h-screen sm:h-[550px] overflow-y-auto shadow-xl rounded-2xl no-scrollbar flex items-center justify-center p-4">
      <div className="flex flex-col items-center text-center">
        ...
        <img
          src={Image}
          alt="Decorative"
          className="w-[90%] sm:w-[50%] max-w-[90%] h-auto mt-4"
        />
      </div>
    </div>
  );
